...
org.gnome.Builder: repo gnome-builder
	gnome-sdk-bundles/install-rpms gnome-builder.appbuild org.gnome.Builder.Build org.gnome.Sdk org.gnome.Sdk 3.16 libgit2-glib-dev gtksourceview3-dev devhelp-dev
...
RPMS/x86_64/gedit-3.16.0-1.sdk.x86_64.rpm: SOURCES/gedit-3.16.0.tar.xz
	gnome-sdk-bundles/install-rpms gedit.appbuild org.gnome.gedit.Build org.gnome.Sdk org.gnome.Platform 3.16 libpeas-dev gtksourceview3-dev
...
RPMS/x86_64/mesa-demos-8.2.0-1.sdk.x86_64.rpm: SOURCES/mesa-demos-8.2.0.tar.bz2
	gnome-sdk-bundles/install-rpms mesa-demos.appbuild org.freedesktop.glxgears.Build org.freedesktop.Sdk org.freedesktop.Platform 1.0 freeglut-dev libGLU-dev glew-dev
